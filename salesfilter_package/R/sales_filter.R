...
sales_filter<-function(task,min.obs=21,nfolds.cv.glmnet=5,forecast_method="lasso"){
  ...
  if (is.null(task$data_matrix)){
    ...
    matrix<-as.data.frame(sales[,list(datefrom=date(min(date)),dateto=date(max(date))),by=c('lagerID','filid')])
  }else{
    ...
    append(
      append(
        append(
          append(
            append(
              append(append(seq(date('2012-04-09'),date('2012-04-15'),by="day"),
                            seq(date('2013-04-30'),date('2013-05-05'),by="day")),
                     seq(date('2014-04-14'),date('2014-04-20'),by="day")),
              seq(date('2015-04-06'),date('2015-04-12'),by="day")),
            seq(date('2016-04-25'),date('2016-05-01'),by="day")),
          seq(date('2017-04-10'),date('2017-04-16'),by="day")),
        seq(date('2018-04-02'),date('2018-04-08'),by="day")),
      seq(date('2019-04-22'),date('2019-04-28'),by="day")),
    seq(date('2020-04-13'),date('2020-04-19'),by="day")),1,0)
